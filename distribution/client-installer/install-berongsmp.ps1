...
# ---------------------------------------------------------------------------
# 1. Confirm Minecraft has actually been run before (this is the one thing
#    that genuinely cannot be automated - a real Minecraft Java Edition
#    account + the official Launcher having been opened at least once, which
#    is also what provisions the bundled Java runtime this script relies on).
# ---------------------------------------------------------------------------
...
#    Minecraft Launcher (present once Minecraft has been launched at least
#    once) over a system PATH java, since it's guaranteed to be present and
...
# ---------------------------------------------------------------------------
# 4. Drop the mod jar into the mods folder (creating it if needed - this is
#    the exact step that fails when done by hand via the Run dialog, since
#    Win+R can only open a folder that already exists).
# ---------------------------------------------------------------------------
